...
// ─── Okiru Consulting SA — B-BBEE | ESG | AI | Compliance ────────────────────

const crmData = {
  summary: { totalDeals: 96, openDeals: 31, wonDeals: 58, lostDeals: 7, totalRevenue: 4_820_000, avgDealSize: 83_103 },
  pipeline: [
...
const analyticsData = {
  summary: { totalVisitors: 22_840, uniqueVisitors: 15_310, pageViews: 64_220, avgSessionDuration: '4m 18s', bounceRate: '34.2%', conversionRate: '6.8%' },
  trafficSources: [
  ...
  weeklyVisitors: [
    { day: 'Mon', visitors: 3_820 }, { day: 'Tue', visitors: 4_440 }, { day: 'Wed', visitors: 4_980 },
    { day: 'Thu', visitors: 4_310 }, { day: 'Fri', visitors: 3_640 }, { day: 'Sat', visitors: 980   },
  ...
  conversions: { total: 1_554, consultationRequests: 640, trainingSignups: 480, reportDownloads: 310, demoRequests: 124 },
  socialMedia: {
    summary: { totalFollowers: 12_480, followerGrowth: '+500', totalImpressions: 82_320, avgEngagementRate: '4.8%', totalClicks: 3_240, totalPosts: 62 },
    platforms: [
...
const marketingData = {
  summary: { activeCampaigns: 7, totalSpend: 184_000, totalRevenue: 1_420_000, overallROI: '671.7%', leadsGenerated: 924, costPerLead: 199.13 },
  campaigns: [
...
app.get('/api/dashboard', (req, res) => {
  res.json({ success: true, timestamp: new Date().toISOString(), data: {
    crm:       { summary: crmData.summary, recentDeals: crmData.recentDeals.slice(0,3), pipeline: crmData.pipeline },
    analytics: { summary: analyticsData.summary, trafficSources: analyticsData.trafficSources, weeklyVisitors: analyticsData.weeklyVisitors },
    marketing: { summary: marketingData.summary, campaigns: marketingData.campaigns.slice(0,4), channelPerformance: marketingData.channelPerformance },
  }});
});
...
app.listen(PORT, () => console.log(`✅  Okiru HUB running on port ${PORT} [${process.env.NODE_ENV || 'development'}]`));
module.exports = app;
